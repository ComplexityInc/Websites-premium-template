...
// Provided Logos + New Uploads
const Logos = {
  tailwindcss: () => (
    <svg className="h-8 w-auto fill-cyan-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 262 33">
  ...
  aws: () => (
    <svg className="h-10 w-auto fill-foreground" xmlns="http://www.w3.org/2000/svg" viewBox="-45.101 -44.95 390.872 269.7">
      <path d="M86.4 66.4c0 3.7.4 6.7 1.1 8.9.8 2.2 1.8 4.6 3.2 7.2.5.8.7 1.6.7 2.3 0 1-.6 2-1.9 3L83.2 92c-.9.6-1.8.9-2.6.9-1 0-2-.5-3-1.4-1.4-1.5-2.6-3.1-3.6-4.7-1-1.7-2-3.6-3.1-5.9Q59.2 94.7 41.5 94.7c-8.4 0-15.1-2.4-20-7.2s-7.4-11.2-7.4-19.2" />
      <path id="path1859" d="M273.5 143.7c-32.9 24.3-80.7 37.2-121.8 37.2-57.6 0-109.5-21.3-148.7-56.7-3.1-2.8-.3-6.6 3.4-4.4 42.4 24.6 94.7 39.5 148.8 39.5 36.5 0 76.6-7.6 113.5-23.2 5.5-2.5 10.2 3.6 4.8 7.6" fill="#f90" />
      <path d="M287.2 128.1c-4.2-5.4-27.8-2.6-38.5-1.3-3.2.4-3.7-2.4-.8-4.5 18.8-13.2 49.7-9.4 53.3-5 3.6 4.5-1 35.4-18.6 50.2-2.7 2.3-5.3 1.1-4.1-1.9 4-9.9 12.9-32.2 8.7-37.5" fill="#f90" />
    </svg>
  ),
  framer: () => (
    <div className="h-fit flex items-center justify-start font-bold text-xl gap-3">
      <svg viewBox="0 0 14 21" role="presentation" className="h-8 w-auto fill-foreground">
...
const PARTNERS = [
  { name: "Ultrabuilt", logo: "/images/partners/ultrabuilt.png", isCustom: true },
  { name: "CCWA", logo: "/images/partners/ccwa.png", isCustom: true },
  { name: "Adelaide Concrete", logo: "/images/partners/adelaide-concrete.png", isCustom: true },
  { name: "Metro Concrete", logo: "/images/partners/metro-concrete.png", isCustom: true },
  { name: "Partner 1", logo: "/images/partners/new-logo-1.png", isCustom: true },
  { name: "Partner 2", logo: "/images/partners/new-logo-2.png", isCustom: true },
];

export function PartnerMarquee() {
  return (
    <section className="py-32 bg-background overflow-hidden border-t border-border/10">
      <Container>
        <div className="flex flex-col items-center">
          <h3 className="text-sm font-bold uppercase tracking-[0.2em] text-muted-foreground mb-16">
            Who We Work With
          </h3>
          
          <Marquee speed={40} pauseOnHover className="w-full">
            {/* SVG Logos */}
            <div className="mx-12 lg:mx-20 flex items-center justify-center grayscale hover:grayscale-0 transition-all duration-300">
               <Logos.tailwindcss />
            </div>
            <div className="mx-12 lg:mx-20 flex items-center justify-center grayscale hover:grayscale-0 transition-all duration-300">
               <Logos.nextjs />
            ...
            {PARTNERS.map((partner, idx) => (
              <div key={idx} className="mx-12 lg:mx-20 flex items-center justify-center transition-all duration-300">
                <Image 
                   src={partner.logo} 
                   alt={partner.name} 
                   width={200} 
                   height={80} 
                   // Force visibility for white logos on white background via brightness-0 or invert.
                   // The user requested them to be visible. 
